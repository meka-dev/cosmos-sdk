...
replace (
	...
	cosmossdk.io/x/evidence => ../../../evidence
	cosmossdk.io/x/feegrant => ../../../feegrant
	cosmossdk.io/x/mev => ../../
	cosmossdk.io/x/nft => ../../../nft
  cosmossdk.io/x/upgrade => ../../../upgrade
...
require (
	...
	cosmossdk.io/x/mev v0.0.0-00010101000000-000000000000
...
require (
	...
	cosmossdk.io/store v0.1.0 // indirect
	...
	cosmossdk.io/x/upgrade v0.0.0-20230127052425-54c8e1568335 // indirect
